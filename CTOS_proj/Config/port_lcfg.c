...
/*------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
   ...
   {    PORT_PORTF_PIN2,    PORT_Pin_Dir_Output,        PORT_MODE_GPIO,         PORT_INTERNAL_ATTACH_NA,             PORT_IntDisable,                   PORT_PIN_OUTPUT_CURRENT_2mA,            PORT_PIN_UNLOCK     },
   {    PORT_PORTF_PIN3,    PORT_Pin_Dir_Output,        PORT_MODE_GPIO,         PORT_INTERNAL_ATTACH_NA,             PORT_IntDisable,                   PORT_PIN_OUTPUT_CURRENT_2mA,            PORT_PIN_UNLOCK     },
